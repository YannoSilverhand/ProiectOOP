...
namespace Proiectt
{
    ...
    public class ImprimantaCuRasina : Imprimante
    {
        ...
        public ImprimantaCuRasina(string modelImprimanta, string producatorImprimanta, double costImprimanta,
            double nivelulRasinii)
        ...
        public override void Imprimare()
        {
            ...
            {
                Console.WriteLine(
                    $"Imprimarea cu rasina folosind modelul {ModelImprimanta} este in curs de desfasurare!");
    ...
    public class ImprimantaCuFilament : Imprimante
    {
        ...
        public ImprimantaCuFilament(string modelImprimanta, string producatorImprimanta, double costImprimanta,
            double lungimeFilament)
            : base(modelImprimanta, producatorImprimanta, costImprimanta)
        {
        ...
        public void SchimbareFilament(double cantitate, string culoare)
        {
            ...
            Culoare = culoare;
            Console.WriteLine(
                $"Filamentul a fost schimbat. Lungimea actuala a filamentului este de {LungimeFilament} metri.");
        }
        ...
        public override void Imprimare()
        {
            ...
            {
                Console.WriteLine(
                    $"Imprimarea cu filament folosind modelul {ModelImprimanta} este in curs de desfasurare!");
