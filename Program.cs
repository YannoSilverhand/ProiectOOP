    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                // Mentinem utilizatorul conectat până când decide să se deconecteze
                while (true)
                {
                    try
                    {
                    ...
                    {
                        Console.WriteLine($"A apărut o eroare în timpul rulării meniului: {ex.Message}");
                    }
        ...
        static Utilizator AutentificaUtilizator(List<Utilizator> utilizatori, string nume, string parola)
        {
            ...
            {
                Console.WriteLine($"Eroare în autentificare: {ex.Message}");
                return null;
            }
        }
        ...
        static void MeniuAdmin(Administrator admin)
        {
            ...
            {
                Console.WriteLine($"Eroare în meniul Admin: {ex.Message}");
            }
        }
        ...
        static void MeniuUtilizator()
        {
            ...
            {
                Console.WriteLine($"Eroare în meniul Utilizator: {ex.Message}");
            }
        }
    }
}
